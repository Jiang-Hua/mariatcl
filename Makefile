...
#
# RCS: @(#) $Id: Makefile.in,v 1.60 2005/09/13 22:06:37 hobbs Exp $
...
PKG_SOURCES	=  mariatcl.c
PKG_OBJECTS	=  mariatcl.o
...
PKG_LIB_FILE	= libmariatcl0.1.so
PKG_STUB_LIB_FILE = libmariatclstub0.1.a
...
srcdir		= .
prefix		= /home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v6/tcl
exec_prefix	= /home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v6/tcl
...
SHLIB_LD_LIBS	= ${LIBS} -L/home/steve/V3TCLSOURCE/LINUXX64/hdbpacklinux_v6/tcl/lib -ltclstub8.6 -L/usr/lib64 -lmysqlclient
STLIB_LD	= ${AR} cr
...
TCLSH_PROG	= /opt/HammerDB-4.0/bin/tclsh8.6
...
INCLUDES	=  -I"/opt/HammerDB-4.0/include" -I/usr/include/mysql
#INCLUDES	=  -I"/opt/HammerDB-4.0/include" @TK_INCLUDES@ @TK_XINCLUDES@
...
# compiled with.
#DEFS		= $(TCL_DEFS) -DPACKAGE_NAME=\"mariatcl\" -DPACKAGE_TARNAME=\"mariatcl\" -DPACKAGE_VERSION=\"0.1\" -DPACKAGE_STRING=\"mariatcl\ 0.1\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_LIMITS_H=1 -DHAVE_SYS_PARAM_H=1 -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -D_LARGEFILE64_SOURCE=1 -DTCL_WIDE_INT_IS_LONG=1 -DUSE_TCL_STUBS=1 $(PKG_CFLAGS)
DEFS		= -DPACKAGE_NAME=\"mariatcl\" -DPACKAGE_TARNAME=\"mariatcl\" -DPACKAGE_VERSION=\"0.1\" -DPACKAGE_STRING=\"mariatcl\ 0.1\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_LIMITS_H=1 -DHAVE_SYS_PARAM_H=1 -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -D_LARGEFILE64_SOURCE=1 -DTCL_WIDE_INT_IS_LONG=1 -DUSE_TCL_STUBS=1 $(PKG_CFLAGS)
...
dist: dist-clean
	mkdir -p $(DIST_DIR)
	cp -p $(srcdir)/ChangeLog $(srcdir)/README $(srcdir)/README-msqltcl  $(srcdir)/COPYING \
		$(srcdir)/AUTHORS  \
